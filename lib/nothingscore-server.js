...
module.exports={TABLES,awardPoints,canonicalEventId,eventFor,eventMap,eventTiming,freezeSession,identityMaps,leaderboard,pilotFor,profileFor,personaFor,publicProfile,pulseSeedForEvent,rows,rowsPath,snapshots,sydneyMonday};
