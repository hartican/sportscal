const CACHE_NAME = "nothingsport-shell-v264";
const SHELL_VERSION = "264";
const APP_SHELL = [
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=264",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=264",
  "/assets/js/nsc-rankings-ui.js?v=264",
  "/assets/styles/nsc-ladder.css?v=264",
  "/assets/styles/card-clarity.css?v=264",
  "/config/follow-directory-worker.js?v=264",
  ...
  "/styles/follow-feed-rework.css?v=264",
