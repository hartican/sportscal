const CACHE_NAME = "nothingsport-shell-v215";
const APP_SHELL = [
  "/",
  "/index.html",
  "/404.html",
  "/participate.html",
  "/admin.html",
  "/config/admin-comms-workspace.js?v=215",
  "/config/marquee-live-renderer.js?v=215",
  "/config/brand-copy.js",
  "/config/vector-assets.js",
  "/config/national-team-identities.js?v=215",
  "/config/nsc-visual.js?v=215",
  ...
  "/config/preference-reset-ui.js?v=215",
  "/config/user-state-sync.js",
  "/config/chat-contract.js",
  "/config/marquee-campaigns.js",
  "/config/server-sync.js",
  "/config/follow-first.js?v=215",
  "/config/feed-controls.js",
  "/config/ticketing.js",
  "/config/major-events.js?v=215",
  "/config/follow-feed-policy.js?v=215",
