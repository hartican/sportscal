const CACHE_NAME = "nothingsport-shell-v316";
const SHELL_VERSION = "316";
const APP_SHELL = [
  ...
  "/assets/js/app-shell-runtime.js?v=316",
  "/config/tournament-schedule.js?v=316",
  "/assets/js/tennis-schedule-ui.js?v=316",
  ...
  "/styles/follow-feed-rework.css?v=316",
