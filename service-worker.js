const CACHE_NAME = "nothingsport-shell-v276";
const SHELL_VERSION = "276";
const APP_SHELL = [
  ...
  "/assets/js/app-shell-runtime.js?v=275",
  "/assets/js/nsc-rankings-ui.js?v=275",
  ...
  "/styles/follow-feed-rework.css?v=275",
