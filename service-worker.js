const CACHE_NAME = "nothingsport-shell-v288";
const SHELL_VERSION = "288";
const APP_SHELL = [
  "/assets/js/notifications-inbox.js?v=288",
  "/assets/styles/notifications-inbox.css?v=280",
  "/assets/js/app-update.js?v=288",
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=288",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=288",
  "/config/tournament-schedule.js?v=288",
  "/assets/js/tennis-schedule-ui.js?v=288",
  "/assets/js/nsc-rankings-ui.js?v=288",
  "/assets/styles/nsc-ladder.css?v=288",
  ...
  "/styles/follow-feed-rework.css?v=288",
