const CACHE_NAME = "nothingsport-shell-v266";
const SHELL_VERSION = "266";
const APP_SHELL = [
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=266",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=266",
  "/assets/js/nsc-rankings-ui.js?v=266",
  "/assets/styles/nsc-ladder.css?v=266",
  "/assets/styles/card-clarity.css?v=266",
  "/config/follow-directory-worker.js?v=266",
  ...
  "/styles/follow-feed-rework.css?v=266",
