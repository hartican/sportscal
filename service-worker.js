const CACHE_NAME = "nothingsport-shell-v289";
const SHELL_VERSION = "289";
const APP_SHELL = [
  "/assets/js/notifications-inbox.js?v=289",
  "/assets/styles/notifications-inbox.css?v=280",
  "/assets/js/app-update.js?v=289",
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=289",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=289",
  "/config/tournament-schedule.js?v=289",
  "/assets/js/tennis-schedule-ui.js?v=289",
  "/assets/js/nsc-rankings-ui.js?v=289",
  "/assets/styles/nsc-ladder.css?v=289",
  ...
  "/styles/follow-feed-rework.css?v=289",
