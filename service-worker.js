const CACHE_NAME = "nothingsport-shell-v270";
const SHELL_VERSION = "270";
const APP_SHELL = [
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=270",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=270",
  "/assets/js/nsc-rankings-ui.js?v=270",
  "/assets/styles/nsc-ladder.css?v=270",
  "/assets/styles/card-clarity.css?v=270",
  "/config/follow-directory-worker.js?v=270",
  ...
  "/styles/follow-feed-rework.css?v=270",
