const CACHE_NAME = "nothingsport-shell-v239";
const APP_SHELL = [
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=239",
  "/assets/js/app-shell-runtime.js?v=239",
  "/assets/js/nsc-rankings-ui.js?v=239",
  "/assets/identities/events/le-mans-24-hours.png",
  "/styles/follow-feed-rework.css?v=239",
  ...
  "/config/ticketing.js",
  "/config/major-events.js?v=239",
  "/config/follow-feed-policy.js?v=239",
