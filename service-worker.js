const CACHE_NAME = "nothingsport-shell-v287";
const SHELL_VERSION = "287";
const APP_SHELL = [
  "/assets/js/notifications-inbox.js?v=287",
  "/assets/styles/notifications-inbox.css?v=280",
  "/assets/js/app-update.js?v=287",
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=287",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=287",
  "/config/tournament-schedule.js?v=287",
  "/assets/js/tennis-schedule-ui.js?v=287",
  "/assets/js/nsc-rankings-ui.js?v=287",
  "/assets/styles/nsc-ladder.css?v=287",
  ...
  "/styles/follow-feed-rework.css?v=287",
