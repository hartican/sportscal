const CACHE_NAME = "nothingsport-shell-v218";
const APP_SHELL = [
  "/",
  "/index.html",
  "/404.html",
  ...
  "/config/national-team-identities.js?v=218",
  ...
  "/config/follow-first.js?v=218",
  "/config/feed-controls.js",
  "/config/ticketing.js",
  "/config/major-events.js?v=218",
  "/config/follow-feed-policy.js?v=218",
