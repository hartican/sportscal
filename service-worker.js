const CACHE_NAME = "nothingsport-shell-v265";
const SHELL_VERSION = "265";
const APP_SHELL = [
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=265",
  // Bundled modules are cached once; separate files remain cacheable on demand.
  "/assets/js/app-shell-runtime.js?v=265",
  "/assets/js/nsc-rankings-ui.js?v=265",
  "/assets/styles/nsc-ladder.css?v=265",
  "/assets/styles/card-clarity.css?v=265",
  "/config/follow-directory-worker.js?v=265",
  ...
  "/styles/follow-feed-rework.css?v=265",
