const CACHE_NAME = "nothingsport-shell-v206";
const APP_SHELL = [
  "/",
  "/index.html",
  "/404.html",
  "/participate.html",
  "/admin.html",
  "/config/admin-comms-workspace.js?v=206",
  "/config/marquee-live-renderer.js?v=206",
  "/config/brand-copy.js",
  "/config/vector-assets.js",
  "/config/national-team-identities.js?v=206",
  "/config/nsc-visual.js?v=206",
  ...
  "/config/follow-first.js?v=206",
  "/config/feed-controls.js",
  "/config/ticketing.js",
  "/config/major-events.js?v=206",
  "/config/follow-feed-policy.js?v=206",
