const CACHE_NAME = "nothingsport-shell-v248";
const SHELL_VERSION = "248";
const APP_SHELL = [
  "/assets/js/app-update.js?v=248",
  ...
  "/privacy.html",
  "/terms.html",
  "/assets/styles/nothingsport-foundation.css?v=248",
  "/assets/js/app-shell-runtime.js?v=248",
  "/assets/js/nsc-rankings-ui.js?v=248",
  "/assets/styles/nsc-ladder.css?v=248",
  "/config/calendar-selection.js",
  "/config/follow-summary.js",
  "/assets/identities/events/le-mans-24-hours.png",
  "/styles/follow-feed-rework.css?v=248",
  ...
  "/config/fixture-identity.js?v=248",
  ...
  "/config/follow-first.js?v=248",
  "/config/feed-controls.js",
  "/config/ticketing.js",
  "/config/major-events.js?v=248",
  "/config/follow-feed-policy.js?v=248",
