...
assert(!html.includes('<script src="config/major-events.js"></script>') && html.includes('moduleScriptUrl: "config/major-events.js?v=204"'), "the Events runtime must stay off the critical startup path and load with its catalogue");
...
assert(worker.includes('"/config/major-events.js?v=204"') && worker.includes('"/config/follow-feed-policy.js?v=204"') && worker.includes('"/schemas/major-events.schema.json"'), "Events logic, followed-fixture policy and schema must remain offline-capable");
