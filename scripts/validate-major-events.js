...
assert(worker.includes('"/config/major-events.js?v=223"') && worker.includes('"/config/follow-feed-policy.js?v=218"') && worker.includes('"/schemas/major-events.schema.json"'), "Events logic, followed-fixture policy and schema must remain offline-capable");
