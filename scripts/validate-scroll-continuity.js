...
assert.match(html, /content="163"/, "the app shell version must advance to 163");
assert.match(worker, /nothingsport-shell-v163/, "the service-worker cache must advance with the app shell");
