...
assert(html.includes('PERSONALISED_FEED_CACHE_VERSION = "server-feed.v3:first-page.v11"'), "the redesigned personalised card cache must remain on the current invalidated generation");
