...
assert.match(html, /src="config\/enrichment-engine\.js"/);
...
assert.match(worker, /nothingsport-shell-v225/);
assert.doesNotMatch(worker, /"\/config\/nothingscore\.js"/);
assert.equal(html.match(/<meta name="app-shell-version" content="(\d+)">/)?.[1], "225");
