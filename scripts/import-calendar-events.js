...
const SPORT_RULES = [
  ...
  { id: "wrc", key: "wrc", pattern: /\b(wrc|fia world rally championship)\b/i },
  { id: "general-rally", key: "motorsport", pattern: /\b(paris[- ]dakar|dakar|rally|rally-raid)\b/i },
...
function toImportedEvent(calendar, event) {
  ...
  return {
    ...
    fullSpiel: `Imported from ${calendar.calendarName}. nothingsport categorised this event as ${sport.label} using the ${classification.sportRule} rule and assigned the ${classification.eventRule} event category.`,
