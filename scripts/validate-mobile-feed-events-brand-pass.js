...
assert(html.includes('const verb = viewingLink.liveOrReplay === "replay" ? "Replay" : "Watch";') && html.includes('prefix.textContent = `${verb} on`;'), "watch actions must put the provider mark after Watch on / Replay on");
