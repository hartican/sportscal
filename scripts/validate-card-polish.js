...
assert(html.includes('name="app-shell-version" content="120"') && worker.includes('nothingsport-shell-v120'), "the polished card UI must ship in a matching offline shell version");
