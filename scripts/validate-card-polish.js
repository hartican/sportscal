...
assert(html.includes('name="app-shell-version" content="111"') && worker.includes('nothingsport-shell-v111'), "the polished card UI must ship in a matching offline shell version");
