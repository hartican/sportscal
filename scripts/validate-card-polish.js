...
assert(html.includes('name="app-shell-version" content="119"') && worker.includes('nothingsport-shell-v119'), "the polished card UI must ship in a matching offline shell version");
