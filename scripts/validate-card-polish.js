...
assert(html.includes('name="app-shell-version" content="113"') && worker.includes('nothingsport-shell-v113'), "the polished card UI must ship in a matching offline shell version");
