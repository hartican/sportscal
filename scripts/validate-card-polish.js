...
assert(html.includes(".card-disclosure-row{") && html.includes("justify-content:center;") && !html.includes(".event-card.is-logo-led-event .event-name-line .card-expand-control"), "single-logo titles and their in-flow disclosure must stay centred without overlap");
