...
assert(html.includes('name="app-shell-version" content="115"') && worker.includes('nothingsport-shell-v115'), "the polished card UI must ship in a matching offline shell version");
