...
assert(html.includes('name="app-shell-version" content="139"') && worker.includes('nothingsport-shell-v139'), "the polished card UI must ship in a matching offline shell version");
