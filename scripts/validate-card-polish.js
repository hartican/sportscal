...
assert(html.includes("if(isMinimised || state===\"compact\")") || (html.includes("if(isMinimised || state==='compact')") && html.includes("card.replaceChildren();")), "compact Events cards must replace rich content with the shared compact row");
