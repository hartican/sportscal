...
assert(html.includes('if (!isMinimised && state !== "compact") identity.appendChild(summary);') && html.includes('if (!isMinimised && state === "opened"){'), "compact and minimised Events cards must defer rich details until the second and third levels");
