...
assert(html.includes('name="app-shell-version" content="145"') && worker.includes('nothingsport-shell-v145'), "the polished card UI must ship in a matching offline shell version");
