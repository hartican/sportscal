...
assert(serviceWorkerSource.includes('const CACHE_NAME = "nothingsport-shell-v100"'), "the cricket-identity release must advance the served shell cache");
assert(html.includes('<meta name="app-shell-version" content="100">'), "the served page must expose its shell version for installed-app diagnostics");
