...
assert(serviceWorkerSource.includes('const CACHE_NAME = "nothingsport-shell-v114"'), "the liquid launch release must advance the served shell cache");
assert(html.includes('<meta name="app-shell-version" content="114">'), "the served page must expose its shell version for installed-app diagnostics");
