...
assert(serviceWorkerSource.includes('const CACHE_NAME = "nothingsport-shell-v120"'), "the performance release must advance the served shell cache");
assert(html.includes('<meta name="app-shell-version" content="120">'), "the served page must expose its shell version for installed-app diagnostics");
