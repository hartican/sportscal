...
assert(html.includes('loadDeferredScript("config/sport-hubs.js?v=215")'), "the complete NRL/AFL hub adapter must load on first hub entry without delaying the initial Feed");
