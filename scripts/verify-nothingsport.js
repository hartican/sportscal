...
assert(serviceWorkerSource.includes('const CACHE_NAME = "nothingsport-shell-v145"'), "the startup release must advance the served shell cache");
assert(html.includes('<meta name="app-shell-version" content="145">'), "the served page must expose its shell version for installed-app diagnostics");
