...
const PLACEHOLDER = "Preserved from the existing nothingsport card set until a newer source supersedes it.";
...
const resultOverrides = {
  ...
  evt_79: {
    ...
    competitionId: "competition:fia-wec",
    identityRef: "event:le-mans",
    discipline: "endurance",
    publishedDurationHours: 24,
