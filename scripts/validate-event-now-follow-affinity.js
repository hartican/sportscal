...
assert(html.includes('config/follow-first.js?v=215') && worker.includes('"/config/follow-first.js?v=215"'), "the hierarchical follow runtime must use the current app-shell URL so installed updates cannot retain stale collection identity rules");
