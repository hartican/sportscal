...
assert(html.includes('config/follow-first.js?v=216') && worker.includes('"/config/follow-first.js?v=216"'), "the hierarchical follow runtime must use the current app-shell URL so installed updates cannot retain stale collection identity rules");
