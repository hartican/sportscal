...
assert(cardControlSource.includes('updateEventAction(ev, { isMinimised:true })') && cardControlSource.includes('updateEventAction(ev, { isMinimised:false })') && cardControlSource.includes('setCardState(viewStateEvent, "opened")'), "Minimise and Expand must be separate idempotent actions and Expand must open full detail");
