...
const messageView = section(html, "function chatMessageElement(", "function renderChatPublicProfileForm");
...
assert.match(messageView, /chatAvatarElement\(\{avatarUrl:message\.avatarUrl,displayName:message\.senderName/);
assert.match(messageView, /groupStart \? " group-start" : " group-continuation"/, "consecutive senders must render as stable message groups");
