(function attachSportDomainRegistry(root, factory){
  ...
  const narrativeProfiles = Object.freeze(Object.fromEntries(Object.entries({
    ...
    nbl: { id: "narrative:basketball-finals", signals: [{ match: "game 5|final", label: "Title Decider", archetype: "quest" }, { match: "throwdown|rival|derby", label: "Rivalry", archetype: "rivalry" }] },
  ...
  const domains = [
    ...
    { key: "nbl", domainId: "sport:basketball", preferenceDomainId:"sport:nbl", label: "NBL", selectorLabel: "NBL", detail: "Australian NBL teams and current source-backed player rosters.", color: "var(--c-nba)", glyph: "sport:basketball", sortOrder: 90.5, selector: false, supportsLadders: false, supportsNarrative: true },
