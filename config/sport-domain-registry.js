(function attachSportDomainRegistry(root, factory){
  ...
  const narrativeProfiles = Object.freeze(Object.fromEntries(Object.entries({
    ...
    wsl: { id: "narrative:surf-events", signals: [{ match: "heat|wave|master|heats|board|condition", label: "Must Watch", archetype: "quest" }, { match: "title|championship|winner", label: "Title Decider", archetype: "quest" }, { match: "forecast|swell|wind|tide", label: "Record Chase", archetype: "quest" }] },
    "big-wave": { id: "narrative:surf-events", signals: [{ match: "wave|deep|condition|forecast|title", label: "Must Watch", archetype: "quest" }, { match: "championship|masters|major", label: "Title Decider", archetype: "quest" }] },
    surf: { id: "narrative:surf-events", signals: [{ match: "swell|wave|forecast|lineup|heats", label: "Must Watch", archetype: "quest" }, { match: "title|championship|major", label: "Title Decider", archetype: "quest" }, { match: "record|high score|heat", label: "Record Chase", archetype: "quest" }] },
    ...
    skateboard: { id: "narrative:extreme-sport", signals: [{ match: "park|street|park style|trick|heat", label: "Must Watch", archetype: "quest" }, { match: "title|final|run", label: "Title Decider", archetype: "quest" }, { match: "record|line|height", label: "Record Chase", archetype: "quest" }] },
    ...
    cycling: { id: "narrative:cycling-tour", signals: [{ match: "stage|time trial|climb|sprint", label: "Must Watch", archetype: "quest" }, { match: "final|general|yellow|podium", label: "Title Decider", archetype: "quest" }, { match: "record|time|gap", label: "Record Chase", archetype: "quest" }] },
    ...
    goodwood: { id: "narrative:motorsport-family", signals: [{ match: "hillclimb|event|podium|feature|showdown", label: "Must Watch", archetype: "quest" }, { match: "winner|headline", label: "Title Decider", archetype: "quest" }] },
    ...
    tennis: { id: "narrative:tennis-tour", signals: [{ match: "grand slam|final|1000", label: "Title Decider", archetype: "quest" }, { match: "australian|top 50", label: "Must Watch", archetype: "quest" }] },
  ...
  const domains = [
    ...
    { key: "premier-league", domainId: "sport:football", label: "Premier League", selectorLabel: "Premier League", detail: "Every 2026/27 English Premier League fixture, with club follows and official schedule refreshes.", color: "var(--c-football)", glyph: "sport:football", sortOrder: 41, selector: false, supportsLadders: false, supportsNarrative: true },
