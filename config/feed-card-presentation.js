(function(root,factory){const api=factory();if(typeof module!=='undefined'&&module.exports)module.exports=api;root.NOTHINGSPORTS_FEED_CARD_PRESENTATION=api;})(typeof globalThis!=='undefined'?globalThis:this,function(){
  ...
  const nicknames={'team:football:socceroos':'Socceroos','team:football:matildas':'Matildas','team:cricket:south-africa':'Proteas Men','team:cricket:south-africa-women':'Proteas Women','team:cricket:new-zealand':'Black Caps','team:cricket:new-zealand-women':'White Ferns','team:rugby:australia':'Wallabies','team:rugby:new-zealand':'All Blacks','team:rugby:south-africa':'Springboks'};
  ...
  const hosts={ES:['#b63342','#c59a24'],AU:['#397c66','#c8a733'],GB:['#345a88','#a54454'],IT:['#4e806c','#b64749'],JP:['#b94554','#8e8791'],SG:['#b94b59','#8c8897'],US:['#345a88','#a54454'],BR:['#438368','#c1a53e'],MX:['#448569','#b3444e'],NL:['#c67d40','#b79345'],BE:['#555c65','#b79b3d'],CA:['#b94b59','#8c8897'],FR:['#345a88','#a54454'],CN:['#b94554','#c59a24'],AT:['#b94b59','#8c8897'],HU:['#b94554','#448569'],AZ:['#458da1','#b94554'],QA:['#86425b','#8c8897'],AE:['#448569','#b3444e'],SA:['#448569','#8c8897'],BH:['#b94b59','#8c8897']};
  ...
  function palette(event,sides=[]){
    ...
    if((left.startsWith('team:')&&right.startsWith('team:'))||(['tennis','wimbledon','boxing','mma','ufc'].includes(event.key)&&ids.length===2&&countryTint(left,0)&&countryTint(right,1)))return [club(left)?.[1]||countryTint(left,0)||'#7c8797',club(right)?.[1]||countryTint(right,1)||'#7c8797'];
  ...
  return Object.freeze({dateBanner,venue,ranking,palette,ordinal,displayLabel});
});
